...
namespace SecurityLibrary
{
    public class RailFence : ICryptographicTechnique<string, int>
    {
        ...
        {
            //by training the key from 0 to 26 
            ...
            for (int i = 1; i < plainText.Length; i++)
            {
                ...
                string ciph = Encrypt(plainText, i);//get the cipher of each key and compare it with the cipher text if was matching this is the goal key and we return it
